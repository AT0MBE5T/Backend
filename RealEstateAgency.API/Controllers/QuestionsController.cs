...
namespace RealEstateAgency.API.Controllers
{
    ...
    public class QuestionsController(IQuestionService questionService,
        IAnswerService answerService) : ControllerBase
    {
        [AllowAnonymous]
        ...
        public async Task<IActionResult> GetQuestionsGrid()
        {
            ...
            var result = await questionService.GetQuestionsAnswersGrid();
            return Ok(result);
        }
        ...
        public async Task<IActionResult> DeleteQuestionById([FromBody]Guid questionId)
        {
            ...
            return await questionService.DeleteByQuestionIdAsync(questionId, userId)
                ? Ok()
                : BadRequest();
        }
        ...
        public async Task<IActionResult> DeleteAnswerById([FromBody]Guid answerId)
        {
            ...
            return await answerService.DeleteByAnswerIdAsync(answerId, userId)
                ? Ok()
                : BadRequest();
        }
    }
