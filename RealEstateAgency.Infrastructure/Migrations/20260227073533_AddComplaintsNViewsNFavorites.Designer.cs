...
namespace RealEstateAgency.Infrastructure.Migrations
{
    ...
    [Migration("20260227073533_AddComplaintsNViewsNFavorites")]
    partial class AddComplaintsNViewsNFavorites
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RealEstateAgency.Core.Models.User", b =>
                {
                    ...
                    b.Property<string>("PublicAvatarId")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("public_avatar_id");
            ...
            modelBuilder.Entity("RealEstateAgency.Core.Models.Complaint", b =>
                {
                    ...
                    b.Navigation("ComplaintStatusNavigation");

                    b.Navigation("ComplaintTypeNavigation");
            ...
            modelBuilder.Entity("RealEstateAgency.Core.Models.Announcement", b =>
                {
                    ...
                    b.Navigation("FavoritesNavigation");
